        ...
        <div class="pr-review-wrap">
            <div class="pr-review-rating-wrapper">
                <div class="everyone_review">
                    <div class="pr-review-author-date" style="max-width:20%"><span style="font-size: x-large;">3.5 ${product.overall_rating}/ 5.0 ${product.rating_range}</span> Over All</div>
                </div>
                <div class="targeted_review">
                    <div class="pr-review-author-date" style="max-width:20%"><span style="font-size: x-large;">4.5 ${product.personalized_rating}/ 5.0 ${}</span> Focused</div>
                </div>
